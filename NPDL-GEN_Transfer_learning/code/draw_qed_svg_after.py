...
qed_means = calculate_qed_mean('autodl-tmp/code_final/score_results/iterations_ahc_gpt1_400_topk_0.25_diversity') 
...
plt.savefig('autodl-tmp/code_final/qed_change_during_400_ahc_gpt1_topk_0.25_diversity.svg', dpi=300, bbox_inches='tight', pad_inches=0)
