...
inhibitor_df = pd.read_csv('code_final/datasets/zuhe/train_merged_smiles_with_property.csv')
...
plt.tight_layout()
plt.savefig('code_final/molecular_properties_boxplot.svg', dpi=300, bbox_inches='tight')
plt.show()
