...
def process_smiles_data(train_file, csv_files_pattern):
    ...
    results = []
    for i in range(400):
        file_name = f'autodl-tmp/code_final/score_results/iterations_ahc_gpt1_400_topk_0.25_diversity/step_{i}.csv'
    ...
    result_df.to_csv('autodl-tmp/code_final/smiles_analysis_results.csv', index=False)
    

train_file = 'autodl-tmp/code_final/datasets/zuhe/train_merged_smiles.txt'
csv_files_pattern = 'autodl-tmp/code_final/score_results/iterations_ahc_gpt1_400_topk_0.25_diversity/step_{}.csv'
process_smiles_data(train_file, csv_files_pattern)


plt.rcParams['font.family'] = 'Times New Roman'
# ¶ÁÈ¡ smiles_analysis_results.csv ÎÄ¼þ
df = pd.read_csv('autodl-tmp/code_final/smiles_analysis_results.csv')
...
plt.grid(False)
plt.savefig('autodl-tmp/code_final/novelty_change_during_400_ahc_gpt1_0.25_diversity.svg', bbox_inches='tight',pad_inches=0)
