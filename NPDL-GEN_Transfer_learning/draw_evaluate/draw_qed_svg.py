...
reinvent_means = calculate_qed_mean('NPDL-GEN_Transfer_learning/draw_evaluate/score_results/iterations_reinvent_gpt1_400')
ahc_means = calculate_qed_mean('NPDL-GEN_Transfer_learning/draw_evaluate/score_results/iterations_ahc_gpt1_400')
reinforce_means = calculate_qed_mean('NPDL-GEN_Transfer_learning/draw_evaluate/score_results/iterations_reinforce_gpt1_400')
...
plt.xlim(0,400)
plt.grid(False)
plt.savefig('NPDL-GEN_Transfer_learning/draw_evaluate/ahc_reinvent_reinforce_qed_compare.svg',dpi=300, bbox_inches='tight', pad_inches=0)
plt.show()
