...
data = {
    'MolGPT': get_qed_from_file('NPDL-GEN_Transfer_learning/draw_evaluate/gpt_ahc_diversity_generation_10000_valid_unique.csv'),
    'VAE': get_qed_from_file('NPDL-GEN_Transfer_learning/draw_evaluate/vae_ahc2_early_diversity_generation_10000_valid_unique.csv'),
    'CharRNN': get_qed_from_file('NPDL-GEN_Transfer_learning/draw_evaluate/char_rnn2_ahc_early_diversity_generation_10000_valid_unique.csv'),
    'NP-GEN': get_qed_from_file('NPDL-GEN_Transfer_learning/draw_evaluate/gpt1_ahc_400_topk_0.25_diversity_generation_10000.csv')
}
...
plt.tight_layout()
plt.savefig('NPDL-GEN_Transfer_learning/draw_evaluate/qed_violin_plot_414.svg', dpi=300, bbox_inches='tight', pad_inches=0)
plt.show()