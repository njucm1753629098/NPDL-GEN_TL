...
if __name__ == '__main__':
    ...
    parser.add_argument('--vocab_size', type=int, default = 144, required=False)
    parser.add_argument('--block_size', type=int, default = 212, required=False)
    ...
    tconf = TrainerConfig(max_epochs=args.max_epochs, batch_size=args.batch_size, learning_rate=args.learning_rate,
                            ...
                            ckpt_path=f'NPDL-GEN_Transfer_learning/weights/reinforce-gpt1-400.pt', block_size=train_dataset.max_len, generate=True)
    ...
    df = trainer.train_reinforce(wandb)
