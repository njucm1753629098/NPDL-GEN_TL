...
if __name__ == '__main__':
    ...
    smiles = []
    with open('NPDL-GEN&Transfer_learning/datasets/zuhe/train_merged_smiles.txt', 'r') as train_file:
    ...
    tconf = TrainerConfig(max_epochs=args.max_epochs, batch_size=args.batch_size, learning_rate=args.learning_rate,
                            ...
                            ckpt_path=f'NPDL-GEN&Transfer_learning/weights/reinvent-gpt1-400.pt', block_size=train_dataset.max_len, generate=True)
